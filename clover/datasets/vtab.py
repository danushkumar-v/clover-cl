"""VTAB (Visual Task Adaptation Benchmark - CIL subset) dataset wrapper.

Download: https://drive.google.com/file/d/1xUiwlnx4k0oDhYi26KL5KwrCAya-mvJ_
Expected layout:
    <root>/vtab-cil/vtab/train/<class_id>/...
    <root>/vtab-cil/vtab/test/<class_id>/...
"""
...
_DOWNLOAD_URL = "https://drive.google.com/file/d/1xUiwlnx4k0oDhYi26KL5KwrCAya-mvJ_"
...
class VTABDataset(CLDataset):
    """VTAB-CIL (50-class Visual Task Adaptation Benchmark) wrapper.

    Args:
        root: Parent directory containing the ``vtab-cil/`` subdirectory.
    ...
    Raises:
        FileNotFoundError: If the dataset directory is not found.  Download
            from ``https://drive.google.com/file/d/1xUiwlnx4k0oDhYi26KL5KwrCAya-mvJ_``.
    """
    ...
    def __init__(
        ...
        data_dir = f"{root}/vtab-cil/vtab/{split}"
        try:
            ds = datasets.ImageFolder(data_dir)
        except FileNotFoundError:
            raise FileNotFoundError(
                f"VTAB data not found at {data_dir!r}. "
