"""ImageNet-R dataset wrapper for CLOVER.

Download: https://drive.google.com/file/d/1SG4TbiL8_DooekztyCVK8mPmfhMo8fkR
Expected layout:
    <root>/imagenet-r/train/<class_id>/...
    <root>/imagenet-r/test/<class_id>/...
"""
...
_DOWNLOAD_URL = "https://drive.google.com/file/d/1SG4TbiL8_DooekztyCVK8mPmfhMo8fkR"
...
class ImageNetRDataset(CLDataset):
    """ImageNet-R (200-class artistic renditions) wrapper.

    Args:
        root: Parent directory containing the ``imagenet-r/`` subdirectory.
    ...
    Raises:
        FileNotFoundError: If the dataset directory is not found.  Download
            from ``https://drive.google.com/file/d/1SG4TbiL8_DooekztyCVK8mPmfhMo8fkR``.
    """
    ...
    def __init__(
        ...
        data_dir = f"{root}/imagenet-r/{split}"
        try:
            ds = datasets.ImageFolder(data_dir)
        except FileNotFoundError:
            raise FileNotFoundError(
                f"ImageNet-R data not found at {data_dir!r}. "
