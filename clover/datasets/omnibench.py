"""OmniBenchmark dataset wrapper for CLOVER.

Download: https://drive.google.com/file/d/1AbCP3zBMtv_TDXJypOCnOgX8hJmvJm3u
Expected layout:
    <root>/omnibenchmark/train/<class_id>/...
    <root>/omnibenchmark/test/<class_id>/...
"""
...
_DOWNLOAD_URL = "https://drive.google.com/file/d/1AbCP3zBMtv_TDXJypOCnOgX8hJmvJm3u"
...
class OmniBenchDataset(CLDataset):
    """OmniBenchmark (300-class diverse benchmark) wrapper.

    Args:
        root: Parent directory containing the ``omnibenchmark/`` subdirectory.
    ...
    Raises:
        FileNotFoundError: If the dataset directory is not found.  Download
            from ``https://drive.google.com/file/d/1AbCP3zBMtv_TDXJypOCnOgX8hJmvJm3u``.
    """
    ...
    def __init__(
        ...
        data_dir = f"{root}/omnibenchmark/{split}"
        try:
            ds = datasets.ImageFolder(data_dir)
        except FileNotFoundError:
            raise FileNotFoundError(
                f"OmniBenchmark data not found at {data_dir!r}. "
